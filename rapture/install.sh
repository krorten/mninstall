...
cd ~
echo "***********************************************************"
echo "* Welcome to Kayroons RAPTURE masternode install script   *"
echo "*                                                         *"                                                        
...
echo && echo
echo "${bold}Downloading and installing Rapture Core Files${regular}"
wget https://github.com/RaptureCore/Rapture/releases/download/v1.0.0/rapturecore-1.0.0-linux64.tar.gz
tar xvzf rapturecore-1.0.0-linux64.tar.gz
rm rapturecore-1.0.0-linux64.tar.gz
sudo cp rapturecore-1.0.0/bin/rapture{d,-cli} /usr/local/bin
...
mkdir -p .rapturecore
sudo touch .rapturecore/rapture.conf
echo '
rpcuser='$rpcuser'
