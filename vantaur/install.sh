...
cd ~
echo "***********************************************************"
echo "* Welcome to Kayroons VANTAUR masternode install script *"
echo "*                                                         *"                                                        
...
sudo ufw allow ssh
sudo ufw allow 22812/tcp
sudo ufw allow 22813/tcp
echo "y" | sudo ufw enable
echo && echo "${bold}Firewall installed and enabled!${regular}"

echo && echo
echo "${bold}Downloading and installing Vantaur Files${regular}"
...
mkdir -p .Vantaur
sudo touch .Vantaur/Vantaur.conf
echo '
rpcuser='$rpcuser'
...
masternode=1
' | sudo -E tee /root/.Vantaur/Vantaur.conf
sleep 3
echo && echo "${bold}Starting Vantaur Deamon...${regular}"
vantaurd stop
sleep 10
vantaurd -deamon &
sleep 3
echo && echo "${bold}Checking Vantaur Deamon...${regular}"
vantaurd getinfo
