...
cd ~
echo "***********************************************************"
echo "* Welcome to Kayroons BitcoinAdult masternode install script *"
echo "*                                                         *"                                                        
...
sudo apt-get update -y
sudo apt-get install libdb4.8-dev libdb4.8++-dev libzmq5 -y
...
echo && echo
echo "${bold}Downloading and installing BitcoinAdult Files${regular}"
wget https://github.com/zoldur/BitcoinAdult/releases/download/v1.0.0.0/BitcoinAdult.tar.gz
tar xvzf BitcoinAdult.tar.gz
rm BitcoinAdult.tar.gz
sudo cp BitcoinAdult{d,-cli} /usr/local/bin
...
mkdir -p .BitcoinAdult
sudo touch .BitcoinAdult/BitcoinAdult.conf
echo '
rpcuser='$rpcuser'
...
masternode=1
' | sudo -E tee /root/.BitcoinAdult/BitcoinAdult.conf
sleep 3
echo && echo "${bold}Checking BitcoinAdult Deamon...${regular}"
BitcoinAdultd --deamon &
sleep 2
BitcoinAdult-cli getinfo
